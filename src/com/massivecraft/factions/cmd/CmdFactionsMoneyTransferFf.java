...
public class CmdFactionsMoneyTransferFf extends FactionsCommand
{
	...
	public void perform() throws MassiveException
	{
		...
		{
			Factions.get().log(ChatColor.stripColor(Txt.parse("%s переданы %s от фракции \"%s\" фракции \"%s\"", msender.getName(), Money.format(amount), from.describeTo(null), to.describeTo(null))));
		}
	}
