...
public class CmdFactionsMoneyTransferFp extends FactionsCommand
{
	...
	public void perform() throws MassiveException
	{
		...
		{
			Factions.get().log(ChatColor.stripColor(Txt.parse("%s переданы %s от фракции \"%s\" игроку \"%s\"", msender.getName(), Money.format(amount), from.describeTo(null), to.describeTo(null))));
		}
	}
