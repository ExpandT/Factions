...
public class CmdFactionsMoneyTransferPf extends FactionsCommand
{
	...
	public void perform() throws MassiveException
	{
		...
		{
			Factions.get().log(ChatColor.stripColor(Txt.parse("%s переданы %s от игрока \"%s\" во фракцию \"%s\"", msender.getName(), Money.format(amount), from.describeTo(null), to.describeTo(null))));
		}
	}
