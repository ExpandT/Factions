...
public class CmdFactionsName extends FactionsCommand
{
	...
	public void perform() throws MassiveException
	{
		...
		// Inform
		faction.msg("%s<i> изменил название своей фракции на %s", msender.describeTo(faction, true), faction.getName(faction));
		if (msenderFaction != faction)
		{
			msg("<i>Вы изменили название фракции на %s", faction.getName(msender));
		}
	}
