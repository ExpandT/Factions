...
public class CmdFactionsOverride extends FactionsCommand
{
	...
	public void perform() throws MassiveException
	{
		...
		// Inform
		String desc = Txt.parse(msender.isOverriding() ? "<g>ВКЛЮЧЕНО" : "<b>ОТКЛЮЧЕНО");
		
		String messageYou = Txt.parse("<i>%s %s <i>режим администратора.", msender.getDisplayName(msender), desc);
		String messageLog = Txt.parse("<i>%s %s <i>режим администратора.", msender.getDisplayName(IdUtil.getConsole()), desc);
