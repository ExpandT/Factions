...
public class CmdFactionsTitle extends FactionsCommand
{
	...
	public void perform() throws MassiveException
	{
		...
		{
			msg("§cВы не можете редактировать именования титулов для более высоких рангов.");
			return;
		}
		...
		// Inform
		msenderFaction.msg("%s<i> изменил титул: %s", msender.describeTo(msenderFaction, true), you.describeTo(msenderFaction, true));
	}
